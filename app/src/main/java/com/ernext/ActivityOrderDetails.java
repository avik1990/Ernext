...
public class ActivityOrderDetails extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderdetails_inc);
        mContext = this;
    ...
    /*private void init() {
        ...
        mPager.setAdapter(new SlidingAdapter_details(ActivityOrderDetails.this, ImagesArray));
