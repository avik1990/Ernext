...
public class Dashboard extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    Context mContext;
    Spinner sp_places;
    RelativeLayout iv_hottestfood, rl_orderfoods;
    RelativeLayout rl_viewchefs, rl_trendings;
    ...
    private void initialization() {
        ...
        fc_recycler_view.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        rl_orderfoods = (RelativeLayout) findViewById(R.id.rl_orderfoods);
        sp_places = (Spinner) findViewById(R.id.sp_places);
        rl_viewchefs = (RelativeLayout) findViewById(R.id.rl_viewchefs);
        rl_trendings = (RelativeLayout) findViewById(R.id.rl_trendings);
        tv_cartcount = (CircularTextView) findViewById(R.id.tv_cartcount);
        tv_cartcount.setSolidColor("#002f49");

        rl_trendings.setOnClickListener(this);
        rl_viewchefs.setOnClickListener(this);
        sp_places.setOnItemSelectedListener(this);
        iv_hottestfood = (RelativeLayout) findViewById(R.id.iv_hottestfood);
        iv_hottestfood.setOnClickListener(this);
        rl_orderfoods.setOnClickListener(this);
    ...
    private void init() {
        ...
        mPager.setAdapter(new SlidingAdapter_dash(Dashboard.this, ImagesArray, TitleArray));
    ...
    public void onClick(View v) {
        if (v == iv_hottestfood) {
            Intent i = new Intent(mContext, ActivityPDetails.class);
            startActivity(i);
        }
        if (v == rl_orderfoods) {
            Intent i = new Intent(mContext, ActivityCart.class);
            startActivity(i);
        }
        if (v == rl_viewchefs) {
            Intent i = new Intent(mContext, ActivityChefs.class);
            startActivity(i);
        }
        if (v == rl_trendings) {
            Intent i = new Intent(mContext, ActivityOrderDetails.class);
            startActivity(i);
        }
        if (v == btn_menu) {
